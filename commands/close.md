...
# User-invocable (default) - typed /gorkhali:close resolves here. The same-named skill (skills/close/SKILL.md) carries user-invocable: false to stay off the / menu; this command remains the canonical procedure and the single menu surface. Do not flip without re-checking menu duplication.
---
