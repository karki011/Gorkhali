...
Read `../references/lifecycle.md`. Stop dispatching immediately. Collect or stop the running Engineer
and record its task ID, commits on the integration branch, uncommitted files, and
blockers in progress. Preserve incomplete work; do not integrate or clean up silently.
