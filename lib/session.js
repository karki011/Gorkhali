 ...
 * fingerprints match; `branch_work` when every active engineer is a branch-mode
 * assignment whose base is HEAD or an ancestor of it, meaning the change is that
