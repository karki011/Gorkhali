...
- **Minimal Comments** -- Comment WHY, not WHAT. No comments that restate the code. Reserve them for non-obvious intent, gotchas, and invariants. Less is more -- steward removes comments that merely describe obvious code.
