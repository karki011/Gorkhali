# Hound Protocol Reference

Author: Subash Karki

Investigation protocol details and HTML report template for hound mode.
...
3. [Pre-scan Output Schema](#pre-scan-output-schema-for-contextjson) — JSON structure for context.json hound field
4. [Failure Scan Output Schema](#failure-scan-output-schema-for-verificationjson) — JSON structure for verification.json hound field
...
|-------|-------|-------------|--------|---------|
| **Pre-scan** | 1-2 | 2-3 | Field in context.json | start.md bug detection |
| **Failure scan** | 1-3 | 4-5 | Field in verification.json | verify.md failure |
| **Full investigation** | All 7 | 8-12 | investigation.html | hound command or fix loop 2+ |

---

## Bug Report Detection Heuristics (for start.md)
...
## Pre-scan Output Schema (for context.json)
...
## Failure Scan Output Schema (for verification.json)
...
Use this template when generating `investigation.html`. Replace `{placeholders}` with actual data. Adapt sections based on investigation depth.
...
<div class="case-header">
  ...
  <div class="meta">
    Investigator: Hound Agent &middot; Date: {DATE} &middot; Depth: {DEPTH}
...
<div class="footer">
  Generated by Hound Mode &middot; Phantom Shadows &middot; {DATE}
</div>
