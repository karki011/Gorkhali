...
```json
{
  ...
  "status": "paused",
  "intent": "~/.claude/phantom/state/sessions/ENG-1234/intent.json",
  "plan": "~/.claude/phantom/state/sessions/ENG-1234/plan.json",
  "contracts": ["~/.claude/phantom/state/sessions/ENG-1234/contracts/api.md"],
  "contractsCompleted": [],
