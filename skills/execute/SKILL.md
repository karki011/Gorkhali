---
name: execute
description: Run an already-APPROVED Phantom plan by dispatching its agents and executing its waves; NOT for unplanned work (start) or resuming prior sessions (resume).
---
## Triggers

Run an already approved Phantom plan by loading its contracts and intent, dispatching its agents, and executing its waves. Use to run or execute an approved plan; use start for unplanned work and resume for prior sessions.
