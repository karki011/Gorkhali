---
name: greploop
description: Iterate a pull request against Greptile review until 5/5 confidence with zero unresolved comments.
---
## Triggers

Iterate on a pull request until Greptile reaches 5/5 confidence with no unresolved actionable comments. Use to run Greploop, clear Greptile feedback, resolve review threads, or optimize a PR against Greptile review.
