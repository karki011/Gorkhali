...
Apply `../../codex-support/codex-compatibility.md` for workflow `pause` before reading the delegated command. It resolves the portable runtime, loads the canonical preambles, then identifies `../../commands/pause.md`.
