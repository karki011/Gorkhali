---
name: recruit
description: Spawn a specialized one-off Blade agent (implementation, research, audit, accessibility, security) outside the normal session flow.
---
## Triggers

Recruit or spawn a specialized Blade agent for a focused implementation, research, audit, accessibility, performance, security, or other one-off role.
