---
name: sessions
description: List and inspect past Phantom sessions - status, dates, tickets - read-only; NOT to continue one (use resume).
---
## Triggers

List and inspect past Phantom sessions, statuses, dates, tickets, contracts, and history to find work that may be resumed.
