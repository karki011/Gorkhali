---
name: status
description: "Show current Phantom progress: active session, running agents, task board, and pending items."
---
## Triggers

Show current Phantom progress, active session, running agents, assignments, contracts, verification, blockers, task board, and cost.
