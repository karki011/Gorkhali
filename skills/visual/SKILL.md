---
name: visual
description: Prepare a human UI-verification checklist, or run optional read-only Phantom Lens inspection when the user explicitly requests Lens; user confirmation remains authoritative.
---
