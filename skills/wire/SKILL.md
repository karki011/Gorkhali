...
Map dependency topology from an approved Gorkhali plan, including execution waves, integration points, ordering, shared files, and risks; use after plan approval or when asked to wire tasks or show implementation dependencies.
