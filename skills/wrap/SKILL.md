...
Finish and ship completed Gorkhali work by enforcing verification, finalizing the session, recording learnings, committing and pushing, and creating a pull request; use for wrap up, ship it, create PR, finalize, or submit work.
